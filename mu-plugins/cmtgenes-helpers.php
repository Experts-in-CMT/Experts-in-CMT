...
/* ============================================================
   ...
   ============================================================ */
add_filter(
    "acf/validate_value/name=subtype",
    function ($valid, $value, $field, $input) {
        ...
        if ($post_id && get_post_type($post_id) !== "subtype") {
            return $valid;
        }
        ...
        $dupe = new WP_Query([
            ...
            "meta_query" => [
                ["key" => "subtype", "value" => $value, "compare" => "="],
            ], // case-insensitive on default collations
            "fields" => "ids",
            "no_found_rows" => true,
        ]);
